...
from r3d3.modules.extractor import BasicEncoder
# from r3d3.modules.corr import CorrBlock
from r3d3.modules.gru import ConvGRU
from r3d3.modules.clipping import GradientClip

# from r3d3.geom.ba import BA

# import r3d3.geom.projective_ops as pops
# from r3d3.geom.graph_utils import graph_to_edge_list, keyframe_indicies
...
class R3D3Net(nn.Module):
    def __init__(self):
        super(R3D3Net, self).__init__()
